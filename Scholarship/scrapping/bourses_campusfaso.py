...
def scraper_bourses_campusfaso():
    ...
    df_bourses_campusfaso.to_csv('bourses_campusfaso.csv')
scraper_bourses_campusfaso()
...
#     # Trouver toutes les sections contenant les informations des bourses
#     scholarships = driver.find_elements(By.CLASS_NAME, "col-md-4.col-sm-6")  # Sélectionner toutes les sections avec la classe spécifiée
...
#         scholarship = driver.find_element(By.CLASS_NAME, "bourse-block")
#         bourses.append(scholarship)
# #class="bourse-block"
#     # Boucle pour extraire les informations de chaque bourse
#     for bourse in bourses:
#         try:
